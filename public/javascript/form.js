/* This file was lifted directly from the demo code from the demo code */
/* for the Stanford Javascript Crypto Library, which is distributed */
/* under a BSD license. https://bitwiseshiftleft.github.io/sjcl/.  I */
/* found the manner in which it created get and set functions for */
/* forms to be novel and educational.  The file has been modified sligtly */
...
function formHandler(formName, enterActions) {
  ...
  tmp = document.getElementById(formName).getElementsByTagName('select');
  for (i=0; i<tmp.length; i++) { els.push(tmp[i]); }
